...
class TravelExpenseClaim(BaseModel):
    ...
    travel_start = models.DateField(default=timezone.localdate, verbose_name=_("Reisebeginn"))
    travel_end = models.DateField(default=timezone.localdate, verbose_name=_("Reiseende"))
