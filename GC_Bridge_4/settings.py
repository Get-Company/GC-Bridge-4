...
MICROTECH_MAINTENANCE_REQUEST_TIMEOUT = float(
    os.getenv("MICROTECH_MAINTENANCE_REQUEST_TIMEOUT", "300")
)
MICROTECH_BACKUP_MODE_DEADLINE_MINUTES = int(
    os.getenv("MICROTECH_BACKUP_MODE_DEADLINE_MINUTES", "90")
)
...
UNFOLD = {
    ...
    "SITE_ICON": "core.unfold.site_icon",
    "SITE_SYMBOL": "hub",
    "SITE_URL": "/",
    "SITE_FAVICONS": [
        {
