...
class Command(MonitoredBaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            help="Gibt für jede Kategorie den Pfad und die Anzahl gefundener ERP-Nummern aus.",
        )
