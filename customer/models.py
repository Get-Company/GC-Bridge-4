...
class Address(BaseModel):
    ...
    street = models.CharField(max_length=255, blank=True, default="", verbose_name=_("Straße"))
    ...
    country_code = models.CharField(max_length=8, blank=True, default="", verbose_name=_("Ländercode"))
    email = models.EmailField(max_length=255, blank=True, default="", verbose_name=_("E-Mail"))
