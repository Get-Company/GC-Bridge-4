...
class MicrotechOrderRuleFormsTest(TestCase):
    ...
    def test_action_form_accepts_name_for_create_text_position(self):
        form = MicrotechOrderRuleActionForm(
            data={
                "is_active": True,
                "priority": 10,
                "ui_action": RULE_ACTION_TARGET_CREATE_TEXT_POSITION,
                "target_value": ".",
            }
        )
        ...
        self.assertIsNone(form.cleaned_data["dataset"])
        self.assertIsNone(form.cleaned_data["dataset_field"])

    def test_action_form_requires_name_for_create_text_position(self):
        form = MicrotechOrderRuleActionForm(
            data={
                "is_active": True,
                "priority": 10,
