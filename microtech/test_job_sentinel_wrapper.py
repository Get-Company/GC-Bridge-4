...
class SubmitWrapperJobTest(TestCase):
    ...
    def test_submit_wrapper_job_creates_queued_job(self, mock_enqueue):
        ...
        with self.captureOnCommitCallbacks(execute=True):
            job = sentinel.submit_wrapper_job(
                ...
                request_payload={"customerNumber": "100012", "input": {}},
    ...
    @patch.object(MicrotechJobSentinelService, "enqueue_graphql_submission")
    def test_submit_wrapper_job_never_executes_the_in_memory_callable(self, mock_enqueue):
        sentinel = MicrotechJobSentinelService()
